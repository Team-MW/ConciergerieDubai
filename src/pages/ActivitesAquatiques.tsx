    ...
    return (
        <>
            ...
            <section className="py-20 bg-gray-50 relative overflow-hidden">
                <div className="absolute top-20 -right-20 opacity-[0.12] pointer-events-none select-none z-0 rotate-90 hidden lg:block">
                    <span className="font-arabic text-[22rem] leading-none text-primary whitespace-nowrap">بحر</span>
                </div>

                <div className="absolute top-1/2 left-0 opacity-[0.04] pointer-events-none select-none z-0 -rotate-45 hidden lg:block">
                    <span className="font-arabic text-[25rem] leading-none text-primary whitespace-nowrap">محيط</span>
                </div>

                <div className="absolute bottom-40 left-0 opacity-[0.08] pointer-events-none select-none z-0 rotate-12 hidden lg:block">
